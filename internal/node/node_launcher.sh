...
export BAZEL_NODE_REQUIRE_PATCH=$(rlocation "TEMPLATED_require_patch_script")

# The main entry point
readonly MAIN=$(rlocation "TEMPLATED_entry_point")
...
require_patch_script=${BAZEL_NODE_REQUIRE_PATCH}
